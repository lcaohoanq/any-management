package com.lcaohoanq.app;

import com.lcaohoanq.app.constants.ResourcePaths;
import com.lcaohoanq.app.controllers.IngredientManagement;
import com.lcaohoanq.app.controllers.MenuManagement;
import com.lcaohoanq.app.controllers.OrderManagement;
import com.lcaohoanq.app.models.MenuBuilder;
...
public class Main {
    public static void main(String[] args) {
        ...
        im.loadDataObject(ResourcePaths.URL_INGREDIENT_DAT);
        mm.loadDataObject(ResourcePaths.URL_MENU_DAT);
        om.loadDataObject(ResourcePaths.URL_ORDER_DAT);
//        om2.
        ...
        do{
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    im.saveDataObject(ResourcePaths.URL_INGREDIENT_DAT);
                    mm.saveDataObject(ResourcePaths.URL_MENU_DAT);
                    om.saveDataObject(ResourcePaths.URL_ORDER_DAT);
                    break;
                case 6:
