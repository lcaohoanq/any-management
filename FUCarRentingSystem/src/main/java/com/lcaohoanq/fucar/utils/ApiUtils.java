...
public class ApiUtils {
    ...
    //{{API_PREFIX}}/scores/users/email?email=ashly.jones@gmail.com&newScore=10
    public static HttpResponse<String> putRequest(String url) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create(url))
            .header("Content-Type", "application/json")
    ...
    public static HttpResponse<String> putRequest(String url, Map<String, String> payload) throws IOException, InterruptedException {
        String jsonPayload = objectMapper.writeValueAsString(payload);
